...
const Nav = () => {
  ...
  return (
    ...
    <nav className=" bg-white border-gray-200 dark:bg-thirdGreen">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button onClick={changeTheme} className="block md:hidden text-white hover:text-textColor">{theme ? <CiLight className="text-xl" /> : <BsMoonStars className="text-xl" />}</button>
        ...
        <div className={` w-full  ${isOpen ? 'block' : 'hidden'} md:block md:w-auto`} id="navbar-default">
          <ul className="font-medium flex flex-col items-center p-4 md:p-0 mt-4  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0   dark:bg-thirdGreen md:dark:bg-thirdGreen ">
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <button onClick={changeTheme} className="text-white hover:text-textColor">{theme ? <CiLight className="text-xl" /> : <BsMoonStars className="text-xl" />}</button>
