...
const Nav = () => {
  ...
  return (
    <nav className="p-4 bg-thirdGreen  dark:bg-gray-900">
      <Container>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between  ">
          ...
          >
            <h1 className="text-white hover:text-textColor text-2xl font-bold mr-auto text-uppercase uppercase">
              Quraishi
            </h1>
          </Link>
          ...
          <button
            ...
            className="block md:hidden text-white hover:text-textColor"
          >
            {darkMode ? (
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden  focus:outline-none  dark:text-gray-50  "
          ...
          >
            <ul className="font-medium flex flex-col items-center p-4 md:p-0 mt-4  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0  ">
              ...
              <button className="block md:hidden text-white hover:text-textColor">
                Resume
              </button>
            </ul>
          </div>
